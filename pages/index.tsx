...
export default function Home() {
  ...
  const femaleModel = '/models/female.glb'
          ...
          <div className="bg-white p-4 rounded shadow">
            ...
            {selected ? (
              ...
              <p className="text-sm text-gray-600">
                Click a hotspot on the body to view clot details.
              </p>
            )}
          </div>

          <div className="bg-yellow-50 p-3 rounded text-sm text-yellow-900">
            <strong>Medical disclaimer:</strong> Educational prototype only. Not for diagnosis or treatment.
          </div>
        </aside>
      </main>
